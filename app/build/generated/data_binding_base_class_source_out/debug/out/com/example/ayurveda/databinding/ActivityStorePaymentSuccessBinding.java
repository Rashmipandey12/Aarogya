...
public final class ActivityStorePaymentSuccessBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final TextView suborderrefno;
  ...
  @NonNull
  public final TextView userName9;

  @NonNull
  public final ImageButton userProfileNavbtn;

  private ActivityStorePaymentSuccessBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageView imageView14, @NonNull ImageView imageView8, @NonNull TextView orderrefno,
      @NonNull ImageButton remedyNavBtn, @NonNull ImageButton storenavbtn,
      @NonNull TextView suborderrefno, @NonNull TextView textView11, @NonNull TextView textView13,
      ...
      @NonNull TextView userName9, @NonNull ImageButton userProfileNavbtn) {
    ...
    this.suborderrefno = suborderrefno;
  ...
  @NonNull
  public static ActivityStorePaymentSuccessBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityStorePaymentSuccessBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_store_payment_success, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityStorePaymentSuccessBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.orderrefno;
      TextView orderrefno = ViewBindings.findChildViewById(rootView, id);
      if (orderrefno == null) {
        break missingId;
      }
      ...
      id = R.id.suborderrefno;
      TextView suborderrefno = ViewBindings.findChildViewById(rootView, id);
      if (suborderrefno == null) {
        break missingId;
      }
      ...
      id = R.id.userName9;
      TextView userName9 = ViewBindings.findChildViewById(rootView, id);
      if (userName9 == null) {
        break missingId;
      }
      ...
      return new ActivityStorePaymentSuccessBinding((ConstraintLayout) rootView, backtoHomebtn,
          docNamePtxt, homenavbtn1, imageView10, imageView14, imageView8, orderrefno, remedyNavBtn,
          storenavbtn, suborderrefno, textView11, textView13, textView14, textView9, unamenavbar,
          userAppointmentsbtn, userName10, userName9, userProfileNavbtn);
    }
