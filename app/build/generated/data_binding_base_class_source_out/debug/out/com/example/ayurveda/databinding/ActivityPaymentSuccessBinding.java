...
public final class ActivityPaymentSuccessBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView subbookingrefno;
  ...
  private ActivityPaymentSuccessBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageButton backtoHomebtn, @NonNull TextView bookingrefno,
      @NonNull TextView docNamePtxt, @NonNull ImageButton homenavbtn1,
      @NonNull ImageView imageView10, @NonNull ImageView imageView14, @NonNull ImageView imageView8,
      @NonNull ImageButton remedyNavBtn, @NonNull ImageButton storenavbtn,
      @NonNull TextView subbookingrefno, @NonNull TextView textView11, @NonNull TextView textView13,
    ...
    this.subbookingrefno = subbookingrefno;
  ...
  public static ActivityPaymentSuccessBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.bookingrefno;
      TextView bookingrefno = ViewBindings.findChildViewById(rootView, id);
      ...
      id = R.id.subbookingrefno;
      TextView subbookingrefno = ViewBindings.findChildViewById(rootView, id);
      if (subbookingrefno == null) {
        break missingId;
      }
      ...
      return new ActivityPaymentSuccessBinding((ConstraintLayout) rootView, backtoHomebtn,
          bookingrefno, docNamePtxt, homenavbtn1, imageView10, imageView14, imageView8,
          remedyNavBtn, storenavbtn, subbookingrefno, textView11, textView13, textView14, textView9,
          unamenavbar, userAppointmentsbtn, userName10, userName9, userProfileNavbtn);
    }
