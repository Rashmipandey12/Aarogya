...
public final class ActivityEditDiagnosisFormBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final Button deletebtnD;

  @NonNull
  public final Button diagEditbtn;
  ...
  private ActivityEditDiagnosisFormBinding(@NonNull ConstraintLayout rootView,
      @NonNull CircleImageView avatarP, @NonNull EditText cardno, @NonNull Button deletebtnD,
      @NonNull Button diagEditbtn, @NonNull TextView docNamePtxt,
    ...
    this.cardno = cardno;
    this.deletebtnD = deletebtnD;
    this.diagEditbtn = diagEditbtn;
  ...
  @NonNull
  public static ActivityEditDiagnosisFormBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityEditDiagnosisFormBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_edit_diagnosis_form, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityEditDiagnosisFormBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.deletebtnD;
      Button deletebtnD = ViewBindings.findChildViewById(rootView, id);
      if (deletebtnD == null) {
        break missingId;
      }

      id = R.id.diagEditbtn;
      Button diagEditbtn = ViewBindings.findChildViewById(rootView, id);
      if (diagEditbtn == null) {
        break missingId;
      }
      ...
      return new ActivityEditDiagnosisFormBinding((ConstraintLayout) rootView, avatarP, cardno,
          deletebtnD, diagEditbtn, docNamePtxt, imageButton10, imageButton45, imageView10,
          imageView8, medication, notes, remedyNavBtn, storenavbtn, textView11, textView13,
          textView14, textView15, textView16, textView17, textView9, unamenavbar,
