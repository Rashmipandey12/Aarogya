...
public final class ActivityDoctorDiagnosisFormBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final TextView datetxtapp;
  ...
  @NonNull
  public final TextView unameappdoc;
  ...
  private ActivityDoctorDiagnosisFormBinding(@NonNull ConstraintLayout rootView,
      @NonNull CircleImageView avatarP, @NonNull EditText cardno, @NonNull TextView datetxtapp,
      @NonNull Button diagSavebtn, @NonNull TextView docNamePtxt,
      @NonNull ImageButton imageButton10, @NonNull ImageButton imageButton45,
      @NonNull ImageView imageView10, @NonNull ImageView imageView8, @NonNull EditText medication,
      @NonNull EditText notes, @NonNull ImageButton remedyNavBtn, @NonNull ImageButton storenavbtn,
      @NonNull TextView textView11, @NonNull TextView textView13, @NonNull TextView textView14,
      @NonNull TextView textView16, @NonNull TextView textView9, @NonNull TextView unameappdoc,
  ...
  @NonNull
  public static ActivityDoctorDiagnosisFormBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityDoctorDiagnosisFormBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_doctor_diagnosis_form, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityDoctorDiagnosisFormBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.datetxtapp;
      TextView datetxtapp = ViewBindings.findChildViewById(rootView, id);
      if (datetxtapp == null) {
        break missingId;
      }
      ...
      id = R.id.unameappdoc;
      TextView unameappdoc = ViewBindings.findChildViewById(rootView, id);
      if (unameappdoc == null) {
        break missingId;
      }
      ...
      return new ActivityDoctorDiagnosisFormBinding((ConstraintLayout) rootView, avatarP, cardno,
          datetxtapp, diagSavebtn, docNamePtxt, imageButton10, imageButton45, imageView10,
          imageView8, medication, notes, remedyNavBtn, storenavbtn, textView11, textView13,
          textView14, textView16, textView9, unameappdoc, unamenavbar, userAppointmentsbtn,
          userProfileNavbtn);
    }
