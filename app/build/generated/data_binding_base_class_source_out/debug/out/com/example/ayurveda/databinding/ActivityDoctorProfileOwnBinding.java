...
public final class ActivityDoctorProfileOwnBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final TextView docAddr;

  @NonNull
  public final TextView docNameProf;

  @NonNull
  public final TextView docPhone;

  @NonNull
  public final TextView docQual;

  @NonNull
  public final TextView docRegNo;

  @NonNull
  public final Button doclogoutbtn;
  ...
  private ActivityDoctorProfileOwnBinding(@NonNull ConstraintLayout rootView,
      @NonNull CircleImageView avatarP, @NonNull ImageButton backtoHomebtn,
      @NonNull TextView docAddr, @NonNull TextView docNameProf, @NonNull TextView docPhone,
      @NonNull TextView docQual, @NonNull TextView docRegNo, @NonNull Button doclogoutbtn,
      ...
      @NonNull ImageView imageView33, @NonNull ImageView imageView8,
    ...
    this.docNameProf = docNameProf;
    this.docPhone = docPhone;
    this.docQual = docQual;
    this.docRegNo = docRegNo;
    this.doclogoutbtn = doclogoutbtn;
  ...
  @NonNull
  public static ActivityDoctorProfileOwnBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityDoctorProfileOwnBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_doctor_profile_own, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityDoctorProfileOwnBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.docAddr;
      TextView docAddr = ViewBindings.findChildViewById(rootView, id);
      if (docAddr == null) {
        break missingId;
      }

      id = R.id.docNameProf;
      TextView docNameProf = ViewBindings.findChildViewById(rootView, id);
      if (docNameProf == null) {
        break missingId;
      }

      id = R.id.docPhone;
      TextView docPhone = ViewBindings.findChildViewById(rootView, id);
      if (docPhone == null) {
        break missingId;
      }

      id = R.id.docQual;
      TextView docQual = ViewBindings.findChildViewById(rootView, id);
      if (docQual == null) {
        break missingId;
      }

      id = R.id.docRegNo;
      TextView docRegNo = ViewBindings.findChildViewById(rootView, id);
      if (docRegNo == null) {
        break missingId;
      }

      id = R.id.doclogoutbtn;
      Button doclogoutbtn = ViewBindings.findChildViewById(rootView, id);
      if (doclogoutbtn == null) {
        break missingId;
      }
      ...
      return new ActivityDoctorProfileOwnBinding((ConstraintLayout) rootView, avatarP,
          backtoHomebtn, docAddr, docNameProf, docPhone, docQual, docRegNo, doclogoutbtn,
          homenavbtn1, imageView10, imageView28, imageView30, imageView31, imageView32, imageView33,
          imageView8, remedyNavBtn, storenavbtn, textView11, textView13, textView14, textView8,
