...
public final class ActivityHerbRecommendationBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final SearchView herbSearch;
  ...
  private ActivityHerbRecommendationBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageButton backbtn, @NonNull TextView cattxt, @NonNull TextView docNamePtxt,
      @NonNull Button doctorsbtn, @NonNull TextView featured, @NonNull SearchView herbSearch,
      ...
      @NonNull ImageView imageView8, @NonNull Button remediesbtn, @NonNull ImageButton remedyNavBtn,
      @NonNull RecyclerView storeRecyclerview, @NonNull ImageButton storenavbtn,
  ...
  @NonNull
  public static ActivityHerbRecommendationBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityHerbRecommendationBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_herb_recommendation, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityHerbRecommendationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.herbSearch;
      SearchView herbSearch = ViewBindings.findChildViewById(rootView, id);
      if (herbSearch == null) {
        break missingId;
      }
      ...
      return new ActivityHerbRecommendationBinding((ConstraintLayout) rootView, backbtn, cattxt,
          docNamePtxt, doctorsbtn, featured, herbSearch, herbsbtn, homenavbtn1, imageButton4,
          imageButton5, imageView10, imageView8, remediesbtn, remedyNavBtn, storeRecyclerview,
