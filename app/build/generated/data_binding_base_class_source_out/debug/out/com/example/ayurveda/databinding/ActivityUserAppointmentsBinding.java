...
public final class ActivityUserAppointmentsBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final RecyclerView completedbookingrecyclerView;
  ...
  @NonNull
  public final RecyclerView pendingbookingrecyclerView;
  ...
  @NonNull
  public final TextView userName12;

  @NonNull
  public final ImageButton userProfileNavbtn;

  private ActivityUserAppointmentsBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageButton backtoHomebtn, @NonNull RecyclerView completedbookingrecyclerView,
      @NonNull TextView docNamePtxt, @NonNull ImageButton homenavbtn1,
      @NonNull ImageView imageView10, @NonNull ImageView imageView8,
      @NonNull RecyclerView pendingbookingrecyclerView, @NonNull ImageButton remedyNavBtn,
      ...
      @NonNull TextView userName12, @NonNull ImageButton userProfileNavbtn) {
    this.rootView = rootView;
    this.backtoHomebtn = backtoHomebtn;
    this.completedbookingrecyclerView = completedbookingrecyclerView;
    this.docNamePtxt = docNamePtxt;
    this.homenavbtn1 = homenavbtn1;
    this.imageView10 = imageView10;
    this.imageView8 = imageView8;
    this.pendingbookingrecyclerView = pendingbookingrecyclerView;
  ...
  @NonNull
  public static ActivityUserAppointmentsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityUserAppointmentsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_user_appointments, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityUserAppointmentsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.completedbookingrecyclerView;
      RecyclerView completedbookingrecyclerView = ViewBindings.findChildViewById(rootView, id);
      if (completedbookingrecyclerView == null) {
        break missingId;
      }
      ...
      id = R.id.pendingbookingrecyclerView;
      RecyclerView pendingbookingrecyclerView = ViewBindings.findChildViewById(rootView, id);
      if (pendingbookingrecyclerView == null) {
        break missingId;
      }
      ...
      id = R.id.userName12;
      TextView userName12 = ViewBindings.findChildViewById(rootView, id);
      if (userName12 == null) {
        break missingId;
      }
      ...
      return new ActivityUserAppointmentsBinding((ConstraintLayout) rootView, backtoHomebtn,
          completedbookingrecyclerView, docNamePtxt, homenavbtn1, imageView10, imageView8,
          pendingbookingrecyclerView, remedyNavBtn, storenavbtn, textView11, textView13, textView14,
          textView9, unamenavbar, userAppointmentsbtn, userName10, userName12, userProfileNavbtn);
    }
