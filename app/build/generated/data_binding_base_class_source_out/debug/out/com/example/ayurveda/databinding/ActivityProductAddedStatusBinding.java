...
public final class ActivityProductAddedStatusBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final TextView proaddsuccessref;
  ...
  private ActivityProductAddedStatusBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageView imageView14, @NonNull ImageView imageView8,
      @NonNull TextView proaddsuccessref, @NonNull ImageButton remedyNavBtn,
    ...
    this.proaddsuccessref = proaddsuccessref;
  ...
  @NonNull
  public static ActivityProductAddedStatusBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityProductAddedStatusBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_product_added_status, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityProductAddedStatusBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.proaddsuccessref;
      TextView proaddsuccessref = ViewBindings.findChildViewById(rootView, id);
      if (proaddsuccessref == null) {
        break missingId;
      }
      ...
      return new ActivityProductAddedStatusBinding((ConstraintLayout) rootView, backtoHomebtn,
          docNamePtxt, homenavbtn1, imageView10, imageView14, imageView8, proaddsuccessref,
