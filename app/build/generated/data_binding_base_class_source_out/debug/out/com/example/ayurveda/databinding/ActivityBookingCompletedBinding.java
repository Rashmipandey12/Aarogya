...
public final class ActivityBookingCompletedBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityBookingCompletedBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityBookingCompletedBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityBookingCompletedBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_booking_completed, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityBookingCompletedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBookingCompletedBinding((ConstraintLayout) rootView, bookingNo,
