...
class DoctorProfile : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        backButton.setOnClickListener {
            ...
            val bookNowBtn =
                findViewById<Button>(R.id.booknowbtndocprof) // Replace with the actual ID of your button

            bookNowBtn.setOnClickListener {
                val intent = Intent(
                    this,
                    DoctorBooking::class.java
                ) // Replace "Booking" with the actual name of your booking activity
            ...
            phoneNoTextView.setOnClickListener {
                ...
                if (intent.resolveActivity(packageManager) != null) {
                    ...
                    Toast.makeText(this, "No app found to make a phone call", Toast.LENGTH_SHORT)
                        .show()
                }
            }
