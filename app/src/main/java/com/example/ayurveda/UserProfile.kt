...
class UserProfile : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val userExerciseButton = findViewById<Button>(R.id.userexercise_btn)
        userExerciseButton.setOnClickListener {
            val intent = Intent(this, ExerciseActivity::class.java)
            startActivity(intent)
        }

        val treatmentPackageBtn = findViewById<Button>(R.id.treatmentPackagebtn)
        treatmentPackageBtn.setOnClickListener {
            val intent = Intent(this, TreatmentPackageActivity::class.java)
            startActivity(intent)
        }
            ...
            .addOnSuccessListener { userQuerySnapshot ->
                ...
                if (!userQuerySnapshot.isEmpty) {
                    ...
                    if (userEmail.equals("admin@gmail.com")) {
                        supplierbtnButton.visibility = View.VISIBLE
                    } else {
                        supplierbtnButton.visibility = View.INVISIBLE
                    }
